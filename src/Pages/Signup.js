...
function SignUp() {
  ...
  const submitHandler = (e) => {
    ...
    const details = {
      ...
      company: document.getElementById("company-website").value,
      ...
      insight:
        detail.insight == "Other"
          ? document.getElementById("insightinp").value
          : detail.insight,
    };
    let bol = true;
    console.log(document.getElementById("insightinp").value, details);
          ...
          <form className="oth" onSubmit={submitHandler}>
            <div className="form-inner">
              <div className="auth-welcome">
                <div className="auth-welcome-title">Welcome to Photque!!</div>
              ...
              <div className="signuprow">
                <div className="signuplabel">
                  Company Website{" "}
                  <span className="signuplabel-small">(Optional)</span>
                </div>
              </div>
              <div className="signuprow">
                <TextField
              ...
              <Box
                className="signuprow row"
                sx={{
                  flexDirection: "row-reverse !important",
                }}
              >
                <div className="row signupphonerow2">
                  <CountrySelect />
                  <TextField
                    onChange={(e) => {
                      ...
                      for (let i = 1; i < t.length + 1; i++) {
                        if (i > 1 && i % 3 == 1 && t.length != i - 1) {
                          tt += " ";
                        }
                        tt += t[i - 1];
                      }
                      setDetails({ ...detail, phone: tt });
                    }}
                    id="phone"
                    className="phoneinput"
                    name="number"
                    variant="outlined"
                    placeholder="987 654 321 0"
              ...
              <div className="signuprow">
                <div className="signuplabel">Where did you hear about us ?</div>
                <RadioGroup
                  ...
                  id="insight"
                  className="row"
                  value={detail.insight}
                  onChange={(e) => {
                    setDetails({ ...detail, insight: e.target.value });
                  }}
                >
                  <FormControlLabel
                    value="Linkedin"
              ...
              <div className="signuprow">
                <div className="signuplabel">
                  If other{" "}
                  <span className="signuplabel-small">( please specify )</span>
                </div>
                <TextField
                  name="company website"
                  id="insightinp"
              ...
              <div className="signuprow">
                ...
                <label for="terms">
                  ...
                  <span className="auth-highlight">Terms & Conditions</span> and{" "}
                  <span className="auth-highlight">Privacy Policy</span>
                </label>
              </div>
              <button type="submit" className="signupbutton">
                {resend ? "resend activation" : "Sign Up"}
              </button>
              <br />
              <br />
              <div className="already">
                Already have an account ? &ensp;
                <span onClick={() => go('/signin')} className="auth-highlight">Sign In</span>
              </div>
            </div>
          </form>
          <Signupsvg />
